                    ...
                    <div class="ar-2-3">
                        ...
                        <div class="widget-11 card no-border  no-margin widget-loader-bar">
                            ...
                            <div class="p-l-25 p-r-25 p-b-20">
                                <div class="pull-left">
                                    <h2 class="text-success no-margin">Jobs</h2>
                                </div>
                                <h3 class="pull-right semi-bold"><sup></sup>2017-08-29</h3>
                            ...
                            <div class="padding-25">
                                <p class="small no-margin">
                                    ...
                                    <span class="hint-text ">Show more details for Jobs</span>
                                </p>
                            </div>
                        </div>
                        <!-- END WIDGET -->
                ...
                <div class="visible-xlg col-xlg-3">
                    <div class="ar-2-3">
                        ...
                        <div class="widget-11 card no-border  no-margin widget-loader-bar">
                            ...
                            <div class="p-l-25 p-r-25 p-b-20">
                                <div class="pull-left">
                                    <h2 class="text-success no-margin">Driver Logs</h2>
                                </div>
                                <h3 class="pull-right semi-bold"><sup></sup>2017-08-29</h3>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="padding-25">
                                <p class="small no-margin">
                                    <a href="#"><i class="fa fs-16 fa-arrow-circle-o-down text-success m-r-10"></i></a>
                                    <span class="hint-text ">Show more details for Drivers Logs</span>
                                </p>
                            </div>
                        </div>
                        <!-- END WIDGET -->
                ...
                <div class="visible-xlg col-xlg-3">
                    <div class="ar-2-3">
                        ...
                        <div class="widget-11 card no-border  no-margin widget-loader-bar">
                            ...
                            <div class="p-l-25 p-r-25 p-b-20">
                                <div class="pull-left">
                                    <h2 class="text-success no-margin">Private Drivers</h2>
                                </div>
                                <h3 class="pull-right semi-bold"><sup></sup>2017-08-29</h3>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="padding-25">
                                <p class="small no-margin">
                                    <a href="#"><i class="fa fs-16 fa-arrow-circle-o-down text-success m-r-10"></i></a>
                                    <span class="hint-text ">Show more details for Private Drivers</span>
                                </p>
                            </div>
                        </div>
                        <!-- END WIDGET -->
                ...
                <div class="visible-xlg col-xlg-3">
                    <div class="ar-2-3">
                        ...
                        <div class="widget-11 card no-border  no-margin widget-loader-bar">
                            ...
                            <div class="p-l-25 p-r-25 p-b-20">
                                <div class="pull-left">
                                    <h2 class="text-success no-margin">Containers</h2>
                                </div>
                                <h3 class="pull-right semi-bold"><sup></sup>2017-08-29</h3>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="padding-25">
                                <p class="small no-margin">
                                    <a href="#"><i class="fa fs-16 fa-arrow-circle-o-down text-success m-r-10"></i></a>
                                    <span class="hint-text ">Show more details for Containers</span>
                                </p>
                            </div>
                        </div>
                        <!-- END WIDGET -->
